...
<main {@attach () => {
	...
	<button
		...
		class="w-full h-full flex justify-between px-4 border-2 border-ide-accent/10 rounded-md py-2 items-center absolute top-0 hover:cursor-pointer">
	...
	<div
  	...
  	class="w-full h-0 bg-ide-card rounded-md absolute overflow-hidden {isDropDownMenuShown
  	  ? 'py-1 z-110 border-2 border-accent/10'
