...
<a href="/user/me" aria-label="Profile" aria-current={page.url.pathname.startsWith('/user') ? 'page' : undefined} class="no-underline mah-h-full max-w-full aspect-square">
    ...
    {:else if $avatarQuery.data?.body}
        <div class="-mr-2 ml-4 h-11 w-11 max-h-full max-w-full aspect-square overflow-hidden rounded-full border-3 border-white bg-[color:var(--color-primary)] shadow">
