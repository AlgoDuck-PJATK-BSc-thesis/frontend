...
<main class="mx-auto prose max-w-3xl p-6">
	...
	<p>
		We're sorry to see you go. Deleting your account removes your personal data and is irreversible.
	</p>
	...
	<h2>What happens</h2>
	<ul>
		<li>We revoke active sessions and begin deletion within 30 days.</li>
