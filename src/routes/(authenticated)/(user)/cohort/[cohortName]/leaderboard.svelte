		...
		>
			<div class="mx-auto flex w-full max-w-[38rem] items-center justify-between rounded px-0 py-2">
				...
				>
					...
					<PixelFrameSimple
						className="flex h-max w-full max-w-xl flex-col bg-[linear-gradient(to_bottom,var(--color-accent-3),var(--color-accent-4))] pt-8 pr-2 pb-6 text-[color:var(--color-landingpage-subtitle)]"
					>
