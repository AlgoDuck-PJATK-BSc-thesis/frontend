...
tabindex="0">
    ...
    <dialog 
        class="absolute top-[calc(100%+8px)] left-1/2 -translate-x-1/2 w-max max-w-[320px] p-0 m-0 bg-[#2d2d2d] border border-[#3c3c3c] rounded shadow-[0_4px_16px_rgba(0,0,0,0.4)] z-[9999] animate-[tooltipFade_0.15s_ease] backdrop:bg-transparent before:content-[''] before:absolute before:-top-1.5 before:left-1/2 before:-translate-x-1/2 before:w-0 before:h-0 before:border-l-[6px] before:border-l-transparent before:border-r-[6px] before:border-r-transparent before:border-b-[6px] before:border-b-[#3c3c3c] after:content-[''] after:absolute after:-top-[5px] after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0 after:border-l-[5px] after:border-l-transparent after:border-r-[5px] after:border-r-transparent after:border-b-[5px] after:border-b-[#2d2d2d]" 
