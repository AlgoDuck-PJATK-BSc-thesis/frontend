<script lang="ts">
	import type { NonProblemButtonArgType } from "$lib/types/nonProblemButtonArgType";
...
<button class="w-full h-15 flex justify-start relative mb-1" onclick="{data.onClick}" onmouseenter="{handleMouseEnter}" onmouseleave="{handleMouseLeave}">
    ...
    <div class="h-full z-[1000] w-[18%] {isHovered? 'bg-red-900 shadow-[0_0_5px_5px_rgba(255,0,0,0.5)] shadow-red-500/50' : 'bg-ide-bg'} flex justify-center items-center text-center text-4xl relative">
        <!-- <div class="w-[95%] h-0.5 bg-ide-text-secondary absolute z-10">
        </div> -->
